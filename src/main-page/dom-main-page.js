...
const ERR = new Enum({
  ERROR_MODAL_CONTENT_NOT_FOUND: [
    'Application error',
    "The content couldn't be found",
    'Process: rendering the error modal template',
  ],
  ERROR_MODAL_BUTTON_EXIT_NOT_FOUND: [
    'Application error',
    "The Exit button couldn't be found",
    'Process: applying events on the error modal',
  ],
  ERROR_MODAL_HEADING_NOT_FOUND: [
    'Application error',
    "The Heading couldn't be found",
    'Process: applying events on the error modal',
  ],
  ERROR_MODAL_PARA_NOT_FOUND: [
    'Application error',
    "The Message couldn't be found",
    'Process: applying events on the error modal',
  ],
  REMOVE_MENU_CONTENT_NOT_FOUND: [
    'Application error',
    "The content couldn't be found",
    'Process: rendering the remove confirmation menu template',
  ],
  PROJECT_MENU_TEMPLATE_CONTENT_NOT_FOUND: [
    'Application error',
    "The content couldn't be found",
    'Process: rendering the projects menu template',
  ],
  TASK_MENU_TEMPLATE_CONTENT_NOT_FOUND: [
    'Application error',
    "The content couldn't be found",
    'Process: rendering the tasks menu template',
  ],
  MAIN_PAGE_CONTENT_NOT_FOUND: [
    'Application error',
    "The content couldn't be found",
    'Process: rendering the main page',
  ],
  FILTER_OPTIONS_MAIN_NOT_FOUND: [
    'Application error',
    "The main panel couldn't be found",
    'Process: rendering the filter options menu template',
  ],
  CONTENT_CONTENT_NOT_FOUND: [
    'Application error',
    "One or more core elements of the main page couldn't be found",
    'Process: rendering the content of the main page',
  ],
});
...
function renderErrorModal() {
  ...
  if (!eachIsHTMLElement(content)) {
    throw createErrorObj(ERR.ERROR_MODAL_CONTENT_NOT_FOUND);
  }

  const errorCover = createElementWithAttributes(
    'div',
    {
      class: 'error-cover',
    },
  ...
  const modal = createElementWithAttributes(
    'div',
    {
      class: 'error-modal',
    },
  ...
  const titleBox = createElementWithAttributes(
    'div',
    {
      class: 'title',
    },
  ...
  const heading = createElementWithAttributes(
    'h3',
    {
      class: 'error-heading',
    },
  ...
  const exitIcon = createElementWithAttributes(
    'button',
    {
      class: 'exit',
    },
  ...
  const message = createElementWithAttributes(
    'p',
    {
      class: 'error-message',
    },
  ...
  const process = createElementWithAttributes(
    'span',
    {
      class: 'error-process',
    },
  ...
  const buttonBox = createElementWithAttributes(
    'div',
    {
      class: 'button-box',
    },
  ...
  const buttonExit = createElementWithAttributes(
    'button',
    {
      class: 'exit-ok',
    },
  ...
  const exitMenuThrottle = _.throttle(
    (e) => exitMenu(e),
    KEYPRESS_THROTTLE_TIME,
  );
  function exitMenu(e) {
    if (isPressedKey(e)) {
      if (!eachIsHTMLElement(heading)) {
        throw createErrorObj(ERR.ERROR_MODAL_HEADING_NOT_FOUND);
      }
      if (!eachIsHTMLElement(message)) {
        throw createErrorObj(ERR.ERROR_MODAL_PARA_NOT_FOUND);
      }
...
function renderRemoveConfirmationTemplate() {
  const content = document.querySelector('.content');
  if (!eachIsHTMLElement(content)) {
    throw createErrorObj(ERR.REMOVE_MENU_CONTENT_NOT_FOUND);
  }

  const menuCover = createElementWithAttributes(
    'div',
    {
      class: 'menu-cover',
    },
  ...
  const removeMenu = createElementWithAttributes(
    'div',
    {
      class: 'remove-menu',
    },
  ...
  const projectMenuExitIcon = createElementWithAttributes(
    'button',
    {
      class: 'exit',
    },
  ...
  const buttonConfirm = createElementWithAttributes(
    'button',
    {
  ...
  const handleExitRemoveMenuThrottle = _.throttle(
    (e) => handleExitRemoveMenu(e),
    KEYPRESS_THROTTLE_TIME,
  );
  function handleExitRemoveMenu(e) {
    if (isPressedKey(e)) {
      if (!eachIsHTMLElement(menuCover, removeMenu, heading, message)) {
        throw createErrorObj([
          'Error (exiting the remove confirmation menu)',
          "One or more menu components couldn't be found",
          '',
        ]);
      }
...
function renderProjectMenuTemplate() {
  const content = document.querySelector('.content');
  if (!eachIsHTMLElement(content)) {
    throw createErrorObj(ERR.PROJECT_MENU_TEMPLATE_CONTENT_NOT_FOUND);
  }

  const projectMenu = createElementWithAttributes(
    'div',
    {
      class: 'project-menu',
    },
  ...
  const projectMenuTitleBox = createElementWithAttributes(
    'div',
    {
      class: 'title',
    },
  ...
  const projectMenuTitle = createElementWithAttributes(
    'h3',
    {
      class: 'title-text',
    },
  ...
  const projectNameBox = createElementWithAttributes(
    'div',
    {
      class: 'title-box',
    },
  ...
  const formNameLabel = createElementWithAttributes(
    'label',
    {
      for: 'project-name',
    },
  ...
  const formName = createElementWithAttributes(
    'input',
    {
      type: 'text',
      id: 'project-name',
  ...
  const formIconFieldset = createElementWithAttributes(
    'fieldset',
    {},
    projectMenuForm,
  );
  const formIconLegend = createElementWithAttributes(
    'legend',
    {},
    formIconFieldset,
  );
  ...
  const containerIconOptions = createElementWithAttributes(
    'div',
    {
  ...
  const containerCategoryJob = createElementWithAttributes(
    'div',
    {
  ...
  const iconCategoryJobLabel = createElementWithAttributes(
    'label',
    {
  ...
  const inputCategoryJob = createElementWithAttributes(
    'input',
    {
  ...
  const containerCategoryStudy = createElementWithAttributes(
    'div',
    {
      class: 'project-icon-option',
      tabindex: 0,
  ...
  const iconCategoryStudyLabel = createElementWithAttributes(
    'label',
    {
  ...
  const inputCategoryStudy = createElementWithAttributes(
    'input',
    {
  ...
  const containerCategoryGift = createElementWithAttributes(
    'div',
    {
      class: 'project-icon-option',
      tabindex: 0,
  ...
  const iconCategoryGiftLabel = createElementWithAttributes(
    'label',
    {
  ...
  const inputCategoryGift = createElementWithAttributes(
    'input',
    {
  ...
  const containerCategoryInternational = createElementWithAttributes(
    'div',
    {
      class: 'project-icon-option',
      tabindex: 0,
  ...
  const iconCategoryInternationalLabel = createElementWithAttributes(
    'label',
    {
  ...
  const inputCategoryInternational = createElementWithAttributes(
    'input',
    {
  ...
  inputCategoryInternational.setAttribute(
    'data-alt-text',
    'Category International activity icon',
  );

  const containerCategoryPeople = createElementWithAttributes(
    'div',
    {
      class: 'project-icon-option',
      tabindex: 0,
  ...
  const iconCategoryPeopleLabel = createElementWithAttributes(
    'label',
    {
  ...
  const inputCategoryPeople = createElementWithAttributes(
    'input',
    {
  ...
  const containerCategoryScience = createElementWithAttributes(
    'div',
    {
      class: 'project-icon-option',
      tabindex: 0,
  ...
  const iconCategoryScienceLabel = createElementWithAttributes(
    'label',
    {
  ...
  const inputCategoryScience = createElementWithAttributes(
    'input',
    {
  ...
  const containerCategoryIT = createElementWithAttributes(
    'div',
    {
      class: 'project-icon-option',
      tabindex: 0,
  ...
  const iconCategoryITLabel = createElementWithAttributes(
    'label',
    {
  ...
  const inputCategoryIT = createElementWithAttributes(
    'input',
    {
  ...
  const containerCategoryOther = createElementWithAttributes(
    'div',
    {
      class: 'project-icon-option',
      tabindex: 0,
  ...
  const iconCategoryOtherLabel = createElementWithAttributes(
    'label',
    {
  ...
  const inputCategoryOther = createElementWithAttributes(
    'input',
    {
  ...
  const buttonsGrid = createElementWithAttributes(
    'div',
    {
      class: 'button-box',
    },
  ...
  const buttonSubmit = createElementWithAttributes(
    'button',
    {
      type: 'submit',
      class: 'submit',
  ...
  const buttonCancel = createElementWithAttributes(
    'button',
    {
      class: 'cancel',
    },
...
function renderTaskMenuTemplate() {
  const content = document.querySelector('.content');
  if (!eachIsHTMLElement(content)) {
    throw createErrorObj(ERR.TASK_MENU_TEMPLATE_CONTENT_NOT_FOUND);
  }

  const taskMenu = createElementWithAttributes(
    'div',
    {
      class: 'task-menu',
    },
  ...
  const taskMenuTitleBox = createElementWithAttributes(
    'div',
    {
      class: 'title',
    },
  ...
  const taskMenuTitle = createElementWithAttributes(
    'h3',
    {
      class: 'title-text',
    },
  ...
  const taskMenuExitIcon = createElementWithAttributes(
    'button',
    {
      class: 'exit',
    },
  ...
  const taskMenuForm = createElementWithAttributes('form', {}, taskMenu);
  ...
  const formTitleLabel = createElementWithAttributes(
    'label',
    {
      for: 'task-title',
    },
  ...
  const formTitle = createElementWithAttributes(
    'input',
    {
      type: 'text',
      id: 'task-title',
  ...
  const dueDateBox = createElementWithAttributes(
    'div',
    {
      class: 'due-date-box',
    },
  ...
  const formDueDateLabel = createElementWithAttributes(
    'label',
    {
      for: 'task-dueDate',
    },
  ...
  const formDueDate = createElementWithAttributes(
    'input',
    {
      type: 'date',
      id: 'task-dueDate',
  ...
  const formPriorityFieldset = createElementWithAttributes(
    'fieldset',
    {
      class: 'priority',
    },
  ...
  const formPriorityLegend = createElementWithAttributes(
    'legend',
    {},
    formPriorityFieldset,
  );
  formPriorityLegend.appendChild(
    document.createTextNode("What is the task's priority"),
  );
  formPriorityLegend.appendChild(asteriskRequiredPriority);
  formPriorityLegend.appendChild(document.createTextNode('?'));

  const boxRaradioPriorityHigh = createElementWithAttributes(
    'div',
    {
  ...
  const radioPriorityHigh = createElementWithAttributes(
    'input',
    {
      id: 'priority-high',
      type: 'radio',
  ...
  const labelPriorityHigh = createElementWithAttributes(
    'label',
    {
      for: 'priority-high',
    },
  ...
  const boxRaradioPriorityMedium = createElementWithAttributes(
    'div',
    {
  ...
  const radioPriorityMedium = createElementWithAttributes(
    'input',
    {
      id: 'priority-medium',
      type: 'radio',
  ...
  const labelPriorityMedium = createElementWithAttributes(
    'label',
    {
      for: 'priority-medium',
    },
  ...
  const boxRaradioPriorityNormal = createElementWithAttributes(
    'div',
    {
  ...
  const radioPriorityNormal = createElementWithAttributes(
    'input',
    {
      id: 'priority-normal',
      type: 'radio',
  ...
  const labelPriorityNormal = createElementWithAttributes(
    'label',
    {
      for: 'priority-normal',
    },
  ...
  const descriptionBox = createElementWithAttributes(
    'div',
    {
  ...
  const descriptionLabel = createElementWithAttributes(
    'label',
    {
  ...
  const descriptionTextarea = createElementWithAttributes(
    'textarea',
    {
      id: 'task-description',
      name: 'description',
  ...
  const notesBox = createElementWithAttributes(
    'div',
    {
      class: 'notes-box',
    },
  ...
  const notesLabel = createElementWithAttributes(
    'label',
    {
      for: 'task-notes',
    },
  ...
  const notesTextarea = createElementWithAttributes(
    'textarea',
    {
      id: 'task-notes',
      name: 'notes',
  ...
  const buttonAdd = createElementWithAttributes(
    'button',
    {
      type: 'submit',
      class: 'submit',
...
function renderMainPageFrame() {
  const content = document.querySelector('.content');
  if (!eachIsHTMLElement(content)) {
    throw createErrorObj(ERR.MAIN_PAGE_CONTENT_NOT_FOUND);
  }
  ...
  const sidebarCover = createElementWithAttributes(
    'div',
    { class: 'sidebar-cover' },
    backgroundContainer,
  );
  const main = createElementWithAttributes('main', {}, backgroundContainer);
  const barNavGroups = createElementWithAttributes(
    'div',
    { class: 'sidebar-nav-groups' },
    sidebar,
  );
  const barTypes = createElementWithAttributes(
    'div',
    { class: 'bar-types' },
    barNavGroups,
  );
  const barProjects = createElementWithAttributes(
    'div',
    { class: 'bar-projects' },
    barNavGroups,
  );
  const projectsBarHeader = createElementWithAttributes(
    'div',
    { class: 'header' },
    barProjects,
  );
  const projectsList = createElementWithAttributes(
    'ul',
    { class: 'projects-list' },
    barProjects,
  );
  const projectsBarNavBox = createElementWithAttributes(
    'div',
    { class: 'projects-nav' },
    barProjects,
  );
  const footerLink = createElementWithAttributes(
    'a',
    {
      class: 'bar-footer',
  ...
  const mainHeadBox = createElementWithAttributes(
    'div',
    { class: 'header' },
    main,
  );
  const mainTaskBar = createElementWithAttributes(
    'div',
    { class: 'task-bar' },
    main,
  );
  const tasksList = createElementWithAttributes(
    'ul',
    { class: 'task-list' },
    main,
  );
...
function renderFilterOptionsMenu() {
  ...
  if (!eachIsHTMLElement(backgroundContainer)) {
    throw createErrorObj(ERR.MAIN_PAGE_CONTENT_NOT_FOUND);
  }

  const viewOptionsBox = createElementWithAttributes(
    'div',
    {
  ...
  const priorityContainer = createElementWithAttributes(
    'div',
    {
  ...
  const priorityOptionsText = createElementWithAttributes(
    'div',
    {
  ...
  const priorityBorderContainer = createElementWithAttributes(
    'div',
    {
  ...
  const priorityHighBox = createElementWithAttributes(
    'div',
    {
  ...
  const inputPriorityHigh = createElementWithAttributes(
    'input',
    {
  ...
  const indicatorPriorityHigh = createElementWithAttributes(
    'div',
    {
  ...
  const priorityMediumBox = createElementWithAttributes(
    'div',
    {
  ...
  const inputPriorityMedium = createElementWithAttributes(
    'input',
    {
  ...
  const indicatorPriorityMedium = createElementWithAttributes(
    'div',
    {
  ...
  const priorityNormalBox = createElementWithAttributes(
    'div',
    {
  ...
  const inputPriorityNormal = createElementWithAttributes(
    'input',
    {
  ...
  const indicatorPriorityNormal = createElementWithAttributes(
    'div',
    {
  ...
  const statusContainer = createElementWithAttributes(
    'div',
    {
  ...
  const textOptionsStatus = createElementWithAttributes(
    'div',
    {
      class: 'status-header',
    },
  ...
  const statusBorderContainer = createElementWithAttributes(
    'div',
    {
  ...
  const statusOverdueBox = createElementWithAttributes(
    'div',
    {
  ...
  const inputStatusOverdue = createElementWithAttributes(
    'input',
    {
  ...
  const indicatorStatusOverdue = createElementWithAttributes(
    'div',
    {
  ...
  const labelStatusOverdue = createElementWithAttributes(
    'label',
    {
  ...
  const statusOnGoingBox = createElementWithAttributes(
    'div',
    {
  ...
  const inputStatusOnGoing = createElementWithAttributes(
    'input',
    {
  ...
  const indicatorStatusOnGoing = createElementWithAttributes(
    'div',
    {
  ...
  const labelStatusOnGoing = createElementWithAttributes(
    'label',
    {
  ...
  const statusCompletedBox = createElementWithAttributes(
    'div',
    {
  ...
  const inputStatusCompleted = createElementWithAttributes(
    'input',
    {
  ...
  const indicatorStatusCompleted = createElementWithAttributes(
    'div',
    {
  ...
  const labelStatusCompleted = createElementWithAttributes(
    'label',
    {
  ...
  const sortOptionsBox = createElementWithAttributes(
    'div',
    {
  ...
  const sortOptionsText = createElementWithAttributes(
    'div',
    {
      class: 'sort-header',
    },
  ...
  const sortOptionsBorderContainer = createElementWithAttributes(
    'div',
    {
  ...
  const selectSortOptionsCustom = createElementWithAttributes(
    'div',
    {
      class: 'custom-select',
    },
  ...
  const selectSortOptions = createElementWithAttributes(
    'select',
    {
      name: 'sort-by',
    },
  ...
  const sortByDate = createElementWithAttributes(
    'option',
    {
      value: 'date',
    },
  ...
  const sortByPriority = createElementWithAttributes(
    'option',
    {
      value: 'priority',
    },
  ...
  const sortByStatus = createElementWithAttributes(
    'option',
    {
      value: 'status',
    },
  ...
  const sortOrderBox = createElementWithAttributes(
    'div',
    {
  ...
  const checkboxSortAscendingOrder = createElementWithAttributes(
    'input',
    {
      type: 'checkbox',
      id: 'sort-order',
  ...
  const labelSortOrder = createElementWithAttributes(
    'label',
    {
      class: 'sort-order',
      for: 'sort-order',
...
function renderCustomDropDownMenu() {
  ...
  for (i = 0; i < l; i += 1) {
    ...
    for (j = 0; j < ll; j += 1) {
      ...
      const updateSelectedItemThrottle = _.throttle(
        (ev) => updateSelectedItem(ev),
        KEYPRESS_THROTTLE_TIME,
      );
  ...
  const closeAllSelectThrottle = _.throttle(
    (elmnt) => closeAllSelect(elmnt),
    KEYPRESS_THROTTLE_TIME,
  );
...
function renderMainPageTemplate() {
  ...
  if (
    ...
    throw createErrorObj(ERR.CONTENT_CONTENT_NOT_FOUND);
  }

  const sidebarIcon = createElementWithAttributes(
    'button',
    {
      class: 'sidebar-icon',
    },
  ...
  const logoIcon = createElementWithAttributes(
    'img',
    {
      class: 'logo',
      alt: 'OnTimed logo',
  ...
  const emptyDiv = createElementWithAttributes(
    'div',
    { class: 'empty' },
    header,
  );

  const viewOptionsIcon = createElementWithAttributes(
    'button',
    {
      class: 'options',
    },
  ...
  const tasksAll = createElementWithAttributes(
    'button',
    { class: 'tasks-all' },
    barTypes,
  );
  ...
  const imageTasksAll = createElementWithAttributes(
    'img',
    {
      alt: 'All tasks',
  ...
  const tasksToday = createElementWithAttributes(
    'button',
    { class: 'tasks-today' },
    barTypes,
  );
  ...
  const imagetasksToday = createElementWithAttributes(
    'img',
    {
      alt: 'Tasks today',
  ...
  const tasksWeek = createElementWithAttributes(
    'button',
    { class: 'tasks-week' },
    barTypes,
  );
  ...
  const imageTasksWeekImage = createElementWithAttributes(
    'img',
    {
      alt: 'Tasks this week',
  ...
  const tasksCompleted = createElementWithAttributes(
    'button',
  ...
  const imageTasksCompletedImage = createElementWithAttributes(
    'img',
    {
      alt: 'Tasks completed',
  ...
  const tasksCompletedText = createElementWithAttributes(
    'span',
    {},
    tasksCompleted,
  );
  ...
  const tasksOverdue = createElementWithAttributes(
    'button',
    { class: 'tasks-overdue' },
    barTypes,
  );
  ...
  const imageTasksOverdueImage = createElementWithAttributes(
    'img',
    {
      alt: 'Tasks overdue',
  ...
  const tasksOverdueText = createElementWithAttributes(
    'span',
    {},
    tasksOverdue,
  );
  ...
  const projectsBarHeaderImage = createElementWithAttributes(
    'img',
    {
      alt: 'Projects icon',
    },
  ...
  const projectsBarHeaderText = createElementWithAttributes(
    'span',
    {},
    projectsBarHeader,
  );
  ...
  const emptyDivProjectsBar = createElementWithAttributes(
    'div',
    {},
    projectsBarHeader,
  );

  const projectsBarHeaderAddImage = createElementWithAttributes(
    'button',
    {
      class: 'add-new',
    },
  ...
  projectsBarHeaderAddImage.setAttribute(
    'data-project-action',
    ACTIONS_PROJECTS.ADD_NEW,
  );

  const previousProjectsPageIcon = createElementWithAttributes(
    'button',
    {
  ...
  const projectsPagesNav = createElementWithAttributes(
    'span',
    {
  ...
  const nextProjectsPageIcon = createElementWithAttributes(
    'button',
    {
  ...
  const githubIcon = createElementWithAttributes(
    'img',
    {
      alt: 'GitHub logo',
  ...
  const mainHeadImage = createElementWithAttributes(
    'img',
    {
      alt: 'All tasks icon',
    },
  ...
  const mainTaskNumber = createElementWithAttributes(
    'div',
    { class: 'task-number' },
    mainTaskBar,
  );
  ...
  const addNewTaskIcon = createElementWithAttributes(
    'button',
    {
      class: 'add-new',
    },
  ...
  const taskPageMenuBox = createElementWithAttributes(
    'div',
    { class: 'page-menu' },
    main,
  );

  const previousTasksPageIcon = createElementWithAttributes(
    'button',
    {
  ...
  const tasksPagesNav = createElementWithAttributes(
    'span',
    {
  ...
  const nextTasksPageIcon = createElementWithAttributes(
    'button',
    {
