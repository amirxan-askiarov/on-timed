...
export function getViewOptionsNodes() {
  ...
  const buttonStatusCompleted = document.querySelector(
  ...
  const inputPriorityMedium = document.querySelector(
    "input#view-priority-medium",
  );
  const inputPriorityNormal = document.querySelector(
    "input#view-priority-normal",
  );
  const inputStatusOnGoing = document.querySelector(
    "input#view-status-ongoing",
  );
  const inputStatusCompleted = document.querySelector(
    "input#view-status-completed",
  );
  const inputStatusOverdue = document.querySelector(
    "input#view-status-overdue",
  );
  ...
  const customSelectBox = document.querySelector(
    ".view-options-bar .select-items",
  );
  const toggleBoxes = document.querySelectorAll(
    ".view-options-bar .priority-border-box, .view-options-bar .status-border-box, .view-options-bar .sort-arrow",
  );
